		        ...
		        case '1':
					    ...
					    if(fachada.loginAdm(login, senha)== true){
							...
							case '1':
								...
								String nomeDoEvento = sc2.nextLine(); sc1.nextLine();
								
								System.out.println("Digite o preço do ingresso: ");
							    int preco = sc1.nextInt();sc1.nextLine();
							 ...
							 case '2':
								      System.out.println("Digite o nome do evento: ");
							          String nome1 = sc1.nextLine(); sc1.nextLine(); 
				 ...
				 case '2': 
						 ...
						 case '1':
							     ...
							     System.out.println("\nQuantidade de ingressos: "+fachada.buscarEvento(busca).getLocal().getCapacidade());
