		...
		if (e.getSource() == botaoRemover) {
			...
			if (caixaSenha.getText().equals(clien.getSenha())) {
				...
				if (reply == JOptionPane.YES_OPTION) {
					...
					TelaEspacoCliente espacoCliente = new TelaEspacoCliente();
					espacoCliente.setResizable(false);
					espacoCliente.setLocationRelativeTo(null);
					espacoCliente.setVisible(true);
					dispose();
				}
			} else {
